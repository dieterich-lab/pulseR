...
There are two ways to report the methylation level:
...
boundaries for the parameters. In this case, there following parameters to fit:

- gene specific: expression level $\mu$ and 
...
close to their expected values: for example, the expression level must be
