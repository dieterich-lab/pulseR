...
To reduce parameter number, we use the same normalisation as in the DESeq package
for samples from the *same fraction*.
Strictly speaking, we define _fractions_ as sets of samples, which have different
...
One can specify other options as the number of cores or error 
